...
class AppContainer(context: Context) {
    ...
    // Wake word "Micra" (Porcupine). Inert until a Picovoice AccessKey is set
    // in local.properties; otherwise reports available = false.
    val wakeWord: com.micreta.app.core.voice.WakeWordManager by lazy {
        com.micreta.app.core.voice.PorcupineWakeWordManager(appContext)
    }
